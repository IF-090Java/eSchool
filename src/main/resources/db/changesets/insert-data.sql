...
INSERT INTO class_teacher_subject_link(teacher_id, subject_id, clazz_id) VALUES(1, 1, 1),
(1, 1, 2),
(1, 1, 5),
(2, 3, 1),
(2, 3, 2),
...
(1, 1, '2018-10-22', LOAD_FILE('data.png'), 'впр. 54 ст. 123', 1, 'Practic'),
(1, 2, '2018-10-22', LOAD_FILE('file.txt'), 'впр. 2 ст. 10', 2, 'Labaratorna'),
(1, 5, '2018-10-22', null, 'Пісні Марусі Чурай "Засвіт встали козаченьки" (напам’ять)', 3, 'Practic'),
(1, 3, '2018-10-22', LOAD_FILE('homework.txt'), 'ex. 3 page 12', 4, 'Control'),
(1, 9, '2018-10-22', LOAD_FILE('task.doc'), 'впр. 54, 55, 57 ст. 123', 5, 'Practic'),
(2, 10, '2018-10-22', LOAD_FILE('inf.doc'), 'вивчити параграф 2', 1, 'Module'),
(2, 5, '2018-10-22', null, '"Віють вітри, віють буйні" (читати)', 2, 'Practic'),
(2, 5, '2018-10-22', null, ' "Ой не ходи, Грицю..." (читати)', 3, 'Practic'),
(2, 3, '2018-10-22', LOAD_FILE('homework.txt'), 'ex. 8-16 page 30', 4, 'Control'),
(3, 9, '2018-10-22', LOAD_FILE('teorema.doc'), 'вивчити теорему Піфагора', 1, 'Module'),
(3, 2, '2018-10-22', null, 'ознайомитися з Excel', 2, 'Practic'),
(3, 7, '2018-10-22', LOAD_FILE('help.doc'), 'прочитати параграф 3', 3, 'Practic'),
(3, 3, '2018-10-22', LOAD_FILE('homework.txt'), 'ex. 29, 30 page 35', 4, 'Control'),
(4, 1, '2018-10-22', null, 'підготуватися то контрольної роботи', 1, 'Control'),
(4, 6, '2018-10-22', LOAD_FILE('fiz.doc'), 'впр. 23, 24, 25, 28 ст. 41', 2, 'Practic'),
(4, 4, '2018-10-22', LOAD_FILE('ukrainska.doc'), 'впр. 23, 24, 25, 28 ст. 41', 3, 'Control'),
(5, 2, '2018-10-22', null, 'ознайомитися з Microsoft Word', 1, 'Control'),
(5, 3, '2018-10-22', null, 'ex. 4, 5 page 5', 2, 'Practic'),
(5, 4, '2018-10-22', LOAD_FILE('ukrainska.doc'), 'прочитати параграф 1', 3, 'Practic');